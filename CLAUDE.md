...
- **밤이니까 멈춘다 금지** (Tim 지시 2026-07-27): 시각을 근거로 중단·"내일 하자" 금지. **계속한다** = 코드·문서·조사·측정·PR·리뷰 **+ Tim에게 보내는 질문·승인 요청**(M:j2ur *"나에게 질문하는 것도 시간 고려 안 해도 돼, 방해금지모드라 답이 늦을 수는 있어"*) / **시간을 고려한다** = TTS·알람·스피커 등 물리적 소음(Darren에 대해선 미정 — 확대 적용 금지). 멈출 이유는 **막힘**(승인 대기·정보 부재)이지 시각이 아니고, 대기 중이면 다른 걸 진행한다. 상세 [[feedback_no_stopping_by_clock]]
...
- ⚠️ **왜 옮겼나** (2026-07-31, Darren 승인 M:n3tg): 07-30 23:03 재시작에 세션 cron 이 같이
  사라져 **금요일 07시 브리핑이 말없이 안 나갔다.** 아무도 몰랐다.
  🔑 원래 여기 적혀 있던 경고는 *"7일 후 자동 만료"* 뿐이었다 — **위험 경로가 둘인데 하나만
  적어두니 다른 하나가 조용히 뚫렸다.** ①7일 만료(오래 살면) ②재시작(짧게 살아도, 훨씬 잦음).
  ⇒ **경고를 적어둔 것이 그 축을 감시한다는 뜻은 아니다.** 경고문을 볼 때 물을 것:
    *"이 축이 뚫리는 경로가 여기 적힌 것 하나뿐인가?"*
  🔸 Darren 이 고른 축: *"깜빡했을 때 어떻게 돼?"* — crontab 을 깜빡하면 **틀린 시각에 와서
    시끄럽고**, 세션 cron 을 깜빡하면 **조용히 안 온다.** 잊는 걸 못 막으면 시끄러운 쪽을 고른다.
